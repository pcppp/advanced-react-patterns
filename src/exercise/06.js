...
function useControlledSwitchWarning(
  ...
  React.useEffect(() => {
    warning(
      ...
      `you are changeing the controlled status -- ${{controlPropName}} at ${{
        componentName,
      }} `,
    )
...
function useToggle({
  ...
  // const onIsControlled = Boolean(controlledOn)
  ...
  React.useEffect(() => {
    warning(
      ...
      'you have no way to control the varbel being controlled',
    )
